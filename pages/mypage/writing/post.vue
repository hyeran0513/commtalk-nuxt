...
// 데이터 변환 로직
const transformGridData = (postsPosts) => {
  return postsPosts.map((req) => ({
    postId: req.postId,
...
// gridData 설정
const setGridData = (postsPosts) => {
  gridData.value = transformGridData(postsPosts);
}
